...
extras = [ ...
    ...
    struct('orig','AGBD', 'name','AGBD', ...
        'long_name','Aboveground (woody) Biomass Density', ...
        'units','g m-2', 'scale', 1.0, 'expressed_as',''); ...
    struct('orig','COMherb', 'name','FIREherb', ...
        'long_name','Fire emission (herbaceous)', ...
        'units','kg m-2 s-1', 'scale',TOKGCSEC, 'expressed_as','carbon'); ...
    struct('orig','COMwood', 'name','FIREwood', ...
        'long_name','Fire emission (woody)', ...
        'units','kg m-2 s-1', 'scale',TOKGCSEC, 'expressed_as','carbon'); ...
    struct('orig','COMdefo', 'name','FIREdefo', ...
        'long_name','Fire emission (deforestation)', ...
        'units','kg m-2 s-1', 'scale',TOKGCSEC, 'expressed_as','carbon'); ...
    struct('orig','COMpeat', 'name','FIREpeat', ...
