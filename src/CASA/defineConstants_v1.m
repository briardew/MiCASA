...
% Version 1 had a bug that allowed soil moisture to go negative, but did not affect
% fluxes, and a bug where SINK and ORGC were not divided by the total vegetated
% fraction. This switch reproduces these bugs for zero-diff testing.
